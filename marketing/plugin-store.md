Navigation gives content teams a dedicated place to build menus while developers keep control of the markup. Mix Craft elements and custom URLs, manage the hierarchy visually, and query or render the result through a consistent API.
...
- **Multiple navigations:** Model headers, footers, utility menus and other structures independently.

...
- Fixed node type changes retaining an incompatible or missing linked element in the editor and failing draft autosaves while the new element picker is empty.

import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{A as t,G as n,I as r,L as i,Q as a,R as o,U as s,V as c,X as l,Y as u,j as d,q as f,t as p,z as m}from"./Field-owt98Kgd.js";import{t as h}from"./pk-form-associated-element-DmZKgNPL-B2NKxfMp.js";import{t as g}from"./required-validator-CEg8dvjS-DznAeO8J.js";import{t as _}from"./mirror-validator-DCjNYrrx-BuTMKpbu.js";import{t as v}from"./useEngineField-D704iSvK.js";var y=f`
    @layer pk-component {
        :host {
...
`,b=`#000000`;function x(e){return String(e||``).replace(/^#/,``).replace(/[^0-9a-fA-F]/g,``).slice(0,6).toLowerCase()}function S(e){return e.length===3||e.length===6}function C(e){return e.length===3?e.split(``).map(e=>`${e}${e}`).join(``):e}function w(e){return e.length===6?`#${e}`:e.length===3?`#${C(e)}`:b}var T=class extends h{constructor(...e){super(...e),this.assumeInteractionOn=[`blur`,`input`],this.size=`default`,this.fitCell=!1,this.invalid=!1,this.value=``,this.defaultValue=``,this.ariaLabel=null,this.hexValue=``}static{this.styles=y}static get validators(){return[...super.validators,_(),g()]}connectedCallback(){super.connectedCallback(),this.syncHexFromValue()}willUpdate(e){e.has(`value`)&&this.syncHexFromValue(),super.willUpdate(e)}syncHexFromValue(){this.hexValue=x(this.value)}get validationTarget(){return this.input}syncFormValue(){let e=this.hexValue?`#${this.hexValue}`:``;this.setFormValue(e,e)}resetToDefaultValue(){this.value=this.defaultValue,this.hexValue=x(this.defaultValue)}restoreFormState(e){typeof e==`string`&&(this.value=e,this.hexValue=x(e))}emitChange(){let e=this.hexValue?`#${this.hexValue}`:``;this.value=e,this.dispatchEvent(new CustomEvent(`pk-change`,{detail:{value:e},bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}handleHexInput(e){let t=x(e.target.value);this.hexValue=t,this.emitChange()}handlePickerChange(e){let t=x(e.target.value);this.hexValue=t,this.emitChange()}render(){let e=w(this.hexValue),t=!S(this.hexValue);return n`
        ...
        `}};c([o({reflect:!0})],T.prototype,`size`,void 0),c([o({type:Boolean,reflect:!0,attribute:`fit-cell`})],T.prototype,`fitCell`,void 0),c([o({type:Boolean,reflect:!0})],T.prototype,`invalid`,void 0),c([o()],T.prototype,`value`,void 0),c([o({attribute:`default-value`})],T.prototype,`defaultValue`,void 0),c([o({attribute:`aria-label`})],T.prototype,`ariaLabel`,void 0),c([r(`.hex-input`)],T.prototype,`input`,void 0),c([i()],T.prototype,`hexValue`,void 0),T=c([m(`pk-color-input`)],T);var E=e(a(),1),D=l(),O=u({tagName:`pk-color-input`,elementClass:T,react:E.default,events:{onPkChange:`pk-change`,onInput:`input`,onNativeChange:`change`,onBlur:`blur`}}),k=(0,E.forwardRef)(function({disabled:e,readonly:n,readOnly:r,invalid:i,isInvalid:a,onChange:o,onValueChange:s,onPkChange:c,...l},u){let d=!!(i??a),f=!!(n??r),p=o??s,m=(0,E.useCallback)(e=>{if(c?.(e),!p)return;let t=e.detail;t&&`value`in t&&p(t.value??``)},[c,p]);return(0,D.jsx)(O,{ref:u,...l,...t([`disabled`,`readonly`,`invalid`],{disabled:e,readonly:f,invalid:d}),...p||c?{onPkChange:m}:{}})});k.displayName=`ColorInput`;var A=({form:e,field:t})=>{let{value:n,setValue:r,setTouched:i,errors:a,isInvalid:o}=v(e,t.name);return(0,D.jsx)(p,{name:t.name,label:t.label,instructions:t.instructions,warning:t.warning,required:t.required,errors:a,children:(0,D.jsx)(k,{value:String(n||``),onPkChange:e=>{r(e.detail?.value??``),i()},disabled:t.disabled,invalid:o})})};export{A as ColorField};
//# sourceMappingURL=ColorField-CDfuGdX9.js.map
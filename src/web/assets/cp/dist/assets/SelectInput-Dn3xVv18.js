import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{B as t,G as n,Q as r,R as i,U as a,V as o,X as s,Y as c,q as l,z as u}from"./Field-owt98Kgd.js";import{n as d,r as f,t as p}from"./Select-BBLZtoIA.js";var m=l`
    @layer pk-component {
        :host {
...
`,h=class extends t{constructor(...e){super(...e),this.status=`on`,this.ariaLabel=null}static{this.styles=m}render(){return n`
            <span
                part="base"
                class="status"
                role="status"
            ...
            ></span>
        `}};o([i({reflect:!0})],h.prototype,`status`,void 0),o([i({attribute:`aria-label`})],h.prototype,`ariaLabel`,void 0),h=o([u(`pk-status`)],h);var g=e(r(),1),_=c({tagName:`pk-status`,elementClass:h,react:g.default}),v=s(),y=e=>typeof e==`object`&&!!e&&`group`in e,b=e=>e==null?``:String(e),x=(0,g.forwardRef)(function({options:e,value:t,onChange:n,placeholder:r,disabled:i,isInvalid:a,clearable:o,size:s,width:c,name:l,id:u,onBlur:m,"aria-label":h,"aria-describedby":x,"aria-errormessage":S,"aria-labelledby":C},w){let T=(0,g.useMemo)(()=>e.flatMap(e=>y(e)?e.options:[e]),[e]),E=e=>{if(!n)return;let t=e.detail,r=Array.isArray(t?.value)?t?.value[0]:t?.value,i=T.find(e=>b(e.value)===b(r));n(i?i.value:r??``)},D=e=>(0,v.jsxs)(p,{value:b(e.value),disabled:e.disabled,children:[e.status?(0,v.jsx)(_,{slot:`start`,status:e.status}):null,e.label]},b(e.value));return(0,v.jsx)(f,{ref:w,value:b(t),placeholder:r,disabled:i,invalid:a,clearable:o,size:s,width:c,name:l,id:u,onPkChange:E,onFocusOut:m,"aria-label":h,"aria-describedby":x,"aria-errormessage":S,"aria-labelledby":C,children:e.map(e=>y(e)?(0,v.jsx)(d,{label:e.group,children:e.options.map(D)},e.group):D(e))})});export{_ as n,x as t};
//# sourceMappingURL=SelectInput-Dn3xVv18.js.map
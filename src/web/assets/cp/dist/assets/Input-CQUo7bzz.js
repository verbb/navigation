import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{$ as t,B as n,G as r,H as i,U as a,V as o,W as s,Y as c,Z as l,c as u,i as d,q as f,r as p,u as m,z as h}from"./Field-BGncHpxx.js";import{n as g,r as _,t as v}from"./button-group-item.styles-DYmBR28a-2_dVRVV7.js";import{n as y,t as b}from"./pk-form-associated-element-DmZKgNPL-DDQVQILC.js";import{t as x}from"./required-validator-CEg8dvjS-DznAeO8J.js";import{t as S}from"./mirror-validator-DCjNYrrx-BuTMKpbu.js";import{n as C,t as w}from"./field-labels-CoU9dnNq-qJ92s-2-.js";import{t as T}from"./pk-clear--mPWZP7H-BHgvcQ98.js";import{n as E,t as D}from"./live-HdMcP8Y5.js";var O=o(),k=e(n(),1),A=new Set([`button`,`submit`,`reset`,`checkbox`,`radio`,`file`,`image`,`hidden`]),j=`pk-implicit-submit`,M=(e,t)=>{if(e.key!==`Enter`||e.defaultPrevented||e.isComposing||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return!1;let n=(t||`text`).toLowerCase();return!A.has(n)},N=e=>{let t=e.closest?.(`pk-dialog`);if(t){let e=t.querySelector(`form`);if(e)return e}let n=e.form;return n&&n.id===`main`?e.closest?.(`form`)===n?null:e.closest(`form`):n},P=(e,t,n)=>{if(e.disabled||e.readonly||!M(t,n))return!1;let r=N(e);return!r||r.id===`main`?!1:(t.preventDefault(),t.stopPropagation(),r.dispatchEvent(new CustomEvent(j,{bubbles:!1,cancelable:!0})),!0)},F=t`
    @layer pk-component {
        :host {
            display: block;
            width: 100%;
            ...
            <div part="form-control" class="form-control">
                ...
                <div part="base" class="form-control__input">
                    ...
                    ${i?l`
                        ...
                        `:l`<slot name="end" hidden></slot>`}
                </div>
            </div>
        `}};f([i(`input`)],I.prototype,`input`,void 0),f([s({reflect:!0})],I.prototype,`type`,void 0),f([a()],I.prototype,`value`,null),f([s({attribute:`value`,reflect:!0})],I.prototype,`defaultValue`,void 0),f([s({reflect:!0})],I.prototype,`size`,void 0),f([s()],I.prototype,`label`,void 0),f([s()],I.prototype,`instructions`,void 0),f([s({attribute:`with-clear`,type:Boolean})],I.prototype,`withClear`,void 0),f([s()],I.prototype,`placeholder`,void 0),f([s({type:Boolean,reflect:!0})],I.prototype,`readonly`,void 0),f([s({type:Boolean,reflect:!0})],I.prototype,`invalid`,void 0),f([s({type:Boolean,reflect:!0,attribute:`fit-cell`})],I.prototype,`fitCell`,void 0),f([s({type:Boolean,reflect:!0})],I.prototype,`mono`,void 0),f([s()],I.prototype,`pattern`,void 0),f([s({type:Number})],I.prototype,`minlength`,void 0),f([s({type:Number})],I.prototype,`maxlength`,void 0),f([s()],I.prototype,`min`,void 0),f([s()],I.prototype,`max`,void 0),f([s()],I.prototype,`step`,void 0),f([s()],I.prototype,`autocomplete`,void 0),f([s({type:Boolean,reflect:!0})],I.prototype,`autofocus`,void 0),f([s({attribute:`with-label`,type:Boolean})],I.prototype,`withLabel`,void 0),f([s({attribute:`with-instructions`,type:Boolean})],I.prototype,`withInstructions`,void 0),I=f([r(`pk-input`)],I);var L=h({tagName:`pk-input`,elementClass:I,react:k.default,events:{onInput:`input`,onChange:`input`,onPkClear:`pk-clear`,onFocus:`focus`,onBlur:`blur`}}),R=(0,k.forwardRef)(function(e,t){let{disabled:n,readonly:r,invalid:i,fitCell:a,autofocus:o,mono:s,...c}=e;return(0,O.jsx)(L,{ref:t,...c,...m([`disabled`,`readonly`,`invalid`,`fitCell`,`autofocus`,`mono`],{disabled:n,readonly:r,invalid:i,fitCell:a,autofocus:o,mono:s})})});R.displayName=`Input`;export{R as t};
//# sourceMappingURL=Input-CQUo7bzz.js.map
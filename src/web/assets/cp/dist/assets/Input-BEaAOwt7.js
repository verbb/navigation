import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{$ as t,B as n,G as r,H as i,U as a,V as o,W as s,Y as c,Z as l,c as u,n as d,q as f,s as p,u as m,z as h}from"./Field-B6IiEnwe.js";import{n as g,r as _,t as v}from"./button-group-item.styles-DYmBR28a-D1DgYE8U.js";import{n as y,t as b}from"./pk-form-associated-element-DmZKgNPL-C4SNyMQC.js";import{t as x}from"./required-validator-CEg8dvjS-DznAeO8J.js";import{t as S}from"./mirror-validator-DCjNYrrx-BuTMKpbu.js";import{n as C,t as w}from"./field-labels-CoU9dnNq-qJ92s-2-.js";import{t as T}from"./pk-clear--mPWZP7H-BHgvcQ98.js";import{n as E,t as D}from"./live-BS586Nmb.js";var O=o(),k=e(n(),1),A=new Set([`button`,`submit`,`reset`,`checkbox`,`radio`,`file`,`image`,`hidden`]),j=`pk-implicit-submit`,M=(e,t)=>{if(e.key!==`Enter`||e.defaultPrevented||e.isComposing||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return!1;let n=(t||`text`).toLowerCase();return!A.has(n)},N=e=>{let t=e.closest?.(`pk-dialog`);if(t){let e=t.querySelector(`form`);if(e)return e}let n=e.form;return n&&n.id===`main`?e.closest?.(`form`)===n?null:e.closest(`form`):n},P=(e,t,n)=>{if(e.disabled||e.readonly||!M(t,n))return!1;let r=N(e);return!r||r.id===`main`?!1:(t.preventDefault(),t.stopPropagation(),r.dispatchEvent(new CustomEvent(j,{bubbles:!1,cancelable:!0})),!0)},F=t`
    @layer pk-component {
        :host {
            display: block;
            width: 100%;
...
//# sourceMappingURL=Input-BEaAOwt7.js.map
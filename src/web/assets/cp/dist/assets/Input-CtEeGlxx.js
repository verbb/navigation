import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{B as t,G as n,H as r,L as i,R as a,U as o,V as s,Y as c,Z as l,c as u,i as d,q as f,r as p,u as m,z as h}from"./Field-C0nNpaS-.js";import{n as g,r as _,t as v}from"./button-group-item.styles-DYmBR28a-BiVND-sp.js";import{n as y,t as b}from"./pk-form-associated-element-DmZKgNPL-BMF0IqiY.js";import{t as x}from"./required-validator-CEg8dvjS-DznAeO8J.js";import{t as S}from"./mirror-validator-DCjNYrrx-BuTMKpbu.js";import{n as C,t as w}from"./field-labels-CoU9dnNq-qJ92s-2-.js";import{t as T}from"./pk-clear--mPWZP7H-BHgvcQ98.js";import{n as E,t as D}from"./live-CihwgG8-.js";var O=new Set([`button`,`submit`,`reset`,`checkbox`,`radio`,`file`,`image`,`hidden`]),k=`pk-implicit-submit`,A=(e,t)=>{if(e.key!==`Enter`||e.defaultPrevented||e.isComposing||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return!1;let n=(t||`text`).toLowerCase();return!O.has(n)},j=e=>{let t=e.closest?.(`pk-dialog`);if(t){let e=t.querySelector(`form`);if(e)return e}let n=e.form;return n&&n.id===`main`?e.closest?.(`form`)===n?null:e.closest(`form`):n},M=(e,t,n)=>{if(e.disabled||e.readonly||!A(t,n))return!1;let r=j(e);return!r||r.id===`main`?!1:(t.preventDefault(),t.stopPropagation(),r.dispatchEvent(new CustomEvent(k,{bubbles:!1,cancelable:!0})),!0)},N=l`
    @layer pk-component {
        :host {
            display: block;
            width: 100%;
...
`,P=class extends b{constructor(...e){super(...e),this.assumeInteractionOn=[`blur`,`input`],this.hasSlotController=new u(this,`instructions`,`hint`,`label`,`start`,`end`),this.inputId=p(`pk-input`),this.type=`text`,this._value=null,this.defaultValue=null,this.size=`default`,this.label=``,this.instructions=``,this.withClear=!1,this.placeholder=``,this.readonly=!1,this.invalid=!1,this.fitCell=!1,this.mono=!1,this.autofocus=!1,this.withLabel=!1,this.withInstructions=!1}static{this.styles=[d,_(),g(`.input`,`var(--pk-input-border-radius, var(--pk-radius-sm))`),v(`.input`),N]}static get validators(){return[...super.validators,S(),x()]}get value(){return this.valueHasChanged?this._value??``:this._value??this.defaultValue??``}set value(e){let t=e??``;this._value!==t&&(this.valueHasChanged=!0,this._value=t)}connectedCallback(){this.instructions=C(this,this.instructions),this.hasAttribute(`with-hint`)&&(this.withInstructions=!0),super.connectedCallback()}syncFormValue(){this.setValue(this.value||``)}resetToDefaultValue(){this.valueHasChanged=!1,this._value=null}restoreFormState(e){typeof e==`string`&&(this.value=e)}formResetCallback(){this.valueHasChanged=!1,this._value=null,this.input&&(this.input.value=this.defaultValue??``),super.formResetCallback()}updated(e){(e.has(`value`)||e.has(`defaultValue`))&&this.setState(`blank`,!this.value),super.updated(e)}syncStandaloneAria(){if(!this.input)return;let e=!!this.label||this.hasSlotController.test(`label`,this.withLabel),t=w((e,t)=>this.hasSlotController.test(e,t),this.instructions,this.withInstructions);y({control:this.input,labelId:`${this.inputId}-label`,instructionsId:`${this.inputId}-instructions`,hasLabel:e,hasInstructions:t,required:this.required,invalid:this.invalid||!this.internals.validity.valid})}hasLabelContent(){return!!this.label||this.hasSlotController.test(`label`,this.withLabel)}hasInstructionsContent(){return w((e,t)=>this.hasSlotController.test(e,t),this.instructions,this.withInstructions)}focus(e){this.input?.focus(e)}blur(){this.input?.blur()}select(){this.input?.select()}handleInput(){this.value=this.input.value,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))}handleChange(e){this.value=this.input.value,e.stopPropagation(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}handleKeyDown(e){M(this,e,this.type)}handleClearClick(e){e.preventDefault(),this.value!==``&&(this.value=``,this.dispatchEvent(new T),this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.input.focus())}render(){let e=this.hasLabelContent(),t=this.hasInstructionsContent(),n=this.withClear&&!this.disabled&&!this.readonly&&this.value.length>0,r=this.hasSlotController.test(`start`),i=this.hasSlotController.test(`end`);return c`
        ...
        `}};n([t(`input`)],P.prototype,`input`,void 0),n([r({reflect:!0})],P.prototype,`type`,void 0),n([s()],P.prototype,`value`,null),n([r({attribute:`value`,reflect:!0})],P.prototype,`defaultValue`,void 0),n([r({reflect:!0})],P.prototype,`size`,void 0),n([r()],P.prototype,`label`,void 0),n([r()],P.prototype,`instructions`,void 0),n([r({attribute:`with-clear`,type:Boolean})],P.prototype,`withClear`,void 0),n([r()],P.prototype,`placeholder`,void 0),n([r({type:Boolean,reflect:!0})],P.prototype,`readonly`,void 0),n([r({type:Boolean,reflect:!0})],P.prototype,`invalid`,void 0),n([r({type:Boolean,reflect:!0,attribute:`fit-cell`})],P.prototype,`fitCell`,void 0),n([r({type:Boolean,reflect:!0})],P.prototype,`mono`,void 0),n([r()],P.prototype,`pattern`,void 0),n([r({type:Number})],P.prototype,`minlength`,void 0),n([r({type:Number})],P.prototype,`maxlength`,void 0),n([r()],P.prototype,`min`,void 0),n([r()],P.prototype,`max`,void 0),n([r()],P.prototype,`step`,void 0),n([r()],P.prototype,`autocomplete`,void 0),n([r({type:Boolean,reflect:!0})],P.prototype,`autofocus`,void 0),n([r({attribute:`with-label`,type:Boolean})],P.prototype,`withLabel`,void 0),n([r({attribute:`with-instructions`,type:Boolean})],P.prototype,`withInstructions`,void 0),P=n([o(`pk-input`)],P);var F=e(a(),1),I=h(),L=i({tagName:`pk-input`,elementClass:P,react:F.default,events:{onInput:`input`,onChange:`input`,onPkClear:`pk-clear`,onFocus:`focus`,onBlur:`blur`}}),R=(0,F.forwardRef)(function(e,t){let{disabled:n,readonly:r,invalid:i,fitCell:a,autofocus:o,mono:s,...c}=e;return(0,I.jsx)(L,{ref:t,...c,...m([`disabled`,`readonly`,`invalid`,`fitCell`,`autofocus`,`mono`],{disabled:n,readonly:r,invalid:i,fitCell:a,autofocus:o,mono:s})})});R.displayName=`Input`;export{R as t};
//# sourceMappingURL=Input-CtEeGlxx.js.map
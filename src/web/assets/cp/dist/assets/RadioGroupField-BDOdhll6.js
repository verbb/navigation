import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{$ as t,B as n,G as r,H as i,K as a,U as o,V as s,W as c,Y as l,Z as u,c as d,l as f,n as p,q as m,t as h,u as g,z as _}from"./Field-B6IiEnwe.js";import{i as v}from"./dist-BpymPXnn.js";import{n as y}from"./pk-change-BMLA71i0.js";import{t as b}from"./pk-form-associated-element-DmZKgNPL-C4SNyMQC.js";import{t as x}from"./required-validator-CEg8dvjS-DznAeO8J.js";import{n as S,t as C}from"./field-labels-CoU9dnNq-qJ92s-2-.js";import{t as w}from"./useEngineField-DHTOWczZ.js";var T=s(),E=e(n(),1),D=t`
    @layer pk-component {
        :host {
            display: inline-flex;
...
`,O=class extends a{constructor(...e){super(...e),this.value=``,this.checked=!1,this.disabled=!1,this.invalid=!1,this.required=!1,this.tabIndex=-1,this.ariaLabel=null,this.forceDisabled=!1,this.hasDefaultSlotContent=!1}static{this.styles=D}updated(e){this.input&&e.has(`checked`)&&(this.input.checked=this.checked),this.input&&e.has(`tabIndex`)&&(this.input.tabIndex=this.tabIndex)}focusControl(e){this.input.focus(e)}defaultSlotChanged(e){let t=e.target;this.hasDefaultSlotContent=t.assignedNodes({flatten:!0}).some(e=>e.nodeType===Node.TEXT_NODE?e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE)}handleChange(e){e.stopPropagation();let t=e.target;this.disabled||this.forceDisabled||!t.checked||this.dispatchEvent(new CustomEvent(`pk-radio-select`,{detail:{value:this.value},bubbles:!0,composed:!0}))}render(){let e=this.disabled||this.forceDisabled;return u`
        ...
        `}};m([c()],O.prototype,`value`,void 0),m([c({type:Boolean,reflect:!0})],O.prototype,`checked`,void 0),m([c({type:Boolean,reflect:!0})],O.prototype,`disabled`,void 0),m([c({type:Boolean,reflect:!0})],O.prototype,`invalid`,void 0),m([c({type:Boolean,reflect:!0})],O.prototype,`required`,void 0),m([c({type:Number})],O.prototype,`tabIndex`,void 0),m([c({attribute:`aria-label`})],O.prototype,`ariaLabel`,void 0),m([c({type:Boolean,attribute:!1})],O.prototype,`forceDisabled`,void 0),m([i(`.input`)],O.prototype,`input`,void 0),m([o()],O.prototype,`hasDefaultSlotContent`,void 0),O=m([r(`pk-radio`)],O);var k=t`
    @layer pk-component {
        :host {
            display: block;
            font-family: var(--pk-font-family);
